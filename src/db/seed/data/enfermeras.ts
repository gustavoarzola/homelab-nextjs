 ...
 * enfermera de forma reproducible sin acoplar el catálogo (prod-safe) al PRNG
 * con semilla de la operación (Paso 2).
 */
export function pickByIndex<T>(arr: T[], i: number, salt = 0): T {
